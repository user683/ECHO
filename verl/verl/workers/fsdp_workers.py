...
class ActorRolloutRefWorker(Worker, DistProfilerExtension):
    ...
    def compute_log_prob(self, data: DataProto):
        ...
        calculate_confidence = data.meta_info.pop("calculate_confidence", False)
        confidence_topk = data.meta_info.pop("confidence_topk", 5)
        ...
        with self.ulysses_sharding_manager:
            ...
            with adapter_ctx:
                output, entropys, confidences = self.actor.compute_log_prob(
                    data=data,
    ...
    def compute_ref_log_prob(self, data: DataProto):
        ...
        with self.ulysses_sharding_manager:
            data = self.ulysses_sharding_manager.preprocess_data(data)
            log_probs, _, _ = self.ref_policy.compute_log_prob(
                data=data, calculate_entropy=False, calculate_confidence=False
            )
